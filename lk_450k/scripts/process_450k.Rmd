...
=======
>>>>>>> 91d6f77a38a25b3e102e7b869b8b72c1b68b5f69
...
samples.of.interest <- pd$barcode[pd$group %in% c("Asthmatics", "Controls", "Smokers")]
Betavalues <- Betavalues[,samples.of.interest]
pd <- pd[samples.of.interest,]
...
# combine all stats
beta.stats <- do.call(cbind, list(smoker.means, smoker.sds, control.means, control.sds, asthmatic.means, asthmatic.sds))
colnames(beta.stats) <- c("smoker_mean", "smoker_sd", "control_mean", "control_sd", "asthmatic_mean", "asthmatic_sd")
