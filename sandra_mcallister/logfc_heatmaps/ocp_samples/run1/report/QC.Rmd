---
title: "Quality Control - combined OCP samples, run 1"
author: "`r getOption('author')`"
date: "`r Sys.Date()`"
bibliography: bibliography.bib
params:
    bcb_file: "data/2018-03-30/bcb.rda"
    output_dir: "."
---
...
interestingGroups(bcb) <- c("treatment")
...
### Drop ZA1, ZA2 and CTL3
- low exonic rates, high rRNA rates

```{r plotpca2}
bcb_sub <- bcb[,which(!colData(bcb)$sampleName %in% c("ZA1", "ZA2", "CLT3"))]
...
```{r savesubbedbcb}
saveData(bcb_sub, dir="data/2018-03-30")
```
