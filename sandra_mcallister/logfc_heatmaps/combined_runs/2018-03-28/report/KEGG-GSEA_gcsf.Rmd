---
title: "KEGG GSEA - GCSF"
author: "`r getOption('author')`"
date: "`r Sys.Date()`"
bibliography: bibliography.bib
params:
    bcb_file: "data/2018-04-12/bcb_sub.rda"
    res_file: "data/2018-04-12/res_gcsf.rda"
    organism: "Mm"
    gspecies: "mmu"
    species: "mouse"
    lfc_threshold: 0
...
library(rio)
export(gsea_kegg_result, file=file.path(params$results_dir,  paste(paste("gcsf_gsea_kegg_clusterprofiler_padj",params$alpha,"lfc", params$lfc_threshold, sep = "_"), "xlsx", sep=".")))
