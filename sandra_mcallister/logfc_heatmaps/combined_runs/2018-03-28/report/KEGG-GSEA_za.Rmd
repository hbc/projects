...
params:
    ...
    res_file: "data/2018-04-12/res_za.rda"
    organism: "Mm"
    gspecies: "mmu"
    species: "mouse"
    lfc_threshold: 0
...
library(rio)
export(gsea_kegg_result, file=file.path(params$results_dir,  paste(paste("za_gsea_kegg_clusterprofiler_padj",params$alpha,"lfc", params$lfc_threshold, sep = "_"), "xlsx", sep=".")))
