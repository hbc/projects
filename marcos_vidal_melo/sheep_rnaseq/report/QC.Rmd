...
There is a decent separation between the RU samples and the RL/RM samples along PC1, with PC2 seemingly capturing some of the LPS treatment.
...
There dont' appear to be any strong correlations with the various covariates, though any effects may be muted by the paired design and the apparent similarity of RL and RM samples.
...
There does seem to be some structure in the data, but at this time, it's hard to pull it out.
