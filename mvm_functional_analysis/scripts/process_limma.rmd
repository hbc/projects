...
- load in phenotypes and normalized, annotated array data
...
data <- read_csv(file.path(dataDir, "sheep_exp-modified-DataExploration.csv"))
...
### Unsupervised Clustering of Normalized Data
