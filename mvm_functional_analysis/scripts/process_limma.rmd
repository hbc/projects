...
[This file](./process_limma.rmd) provides code to reproduce the included results and plots. 
...
*(Excel should be albe to import the csv files)*  
...
We can say a gene is significantly differntially expressed genes when it's adjusted pvalue (adj.P.Val) is less than 0.05. You can't use the the raw pvalue (P.Value) because it doesn't take into account that you are doing many, many statistical tests. We adjust for this fact by doing multiple testing correction (described [here](http://www.biostathandbook.com/multiplecomparisons.html)) to get a more accurate sense of how likely are results are false positives.
