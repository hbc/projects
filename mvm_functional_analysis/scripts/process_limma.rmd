...
```{r rawQC, eval=FALSE}
arrayQualityMetrics(expressionset=affyRaw, outdir=file.path(resultsDir, 'report_raw'), force=TRUE, do.logtransform=TRUE, intgroup=c("genotype", "replicate"))
```
...
affyNorm.core <- rma(affyRaw, target="probeset", background=TRUE, normalize=TRUE)
```
