...
- load in phenotypes, normalized pre-annotated expression data, and information about which genes gproilfer recognizes (obtained [here](http://biit.cs.ut.ee/gprofiler/gmt/gprofiler_oaries.NAME.gmt.zip))
