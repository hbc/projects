...
write.xlsx(U133.Plus2.data, file=file.path(metaDir, "unified.metadata.redined.PBMC.U133Plus2.0.xls"), row.names=F)
```
...
- removed GSM844204, failed RLE in raw, and still outlier after normalization
- slope for RNA degradation plots for GSE14642 is very different (flat) and mulitple arrays are outliers for MA plots

- renormalize data

```{r drop_outliers, results='asis'}
...
```{r wo.outliers.normQC, eval=FALSE}
