...
lapply(top.stats, function(n) {
  ...
  output <- cbind(symbols, output)
    write.table(output, file.path(resultsDir, "PBMC", paste("U133_2.0Plus.top100.DE.probesets", contrast, "xls", sep=".")), sep="\t", row.names=F, col.names=T)
  })
```
...
[Adult vs. Child](./results/PBMC/U133_2.0Plus.top100.DE.probesets.adult-child.xls)
[Adult vs. Neonate](./results/PBMC/U133_2.0Plus.top100.DE.probesets.adult-neonate.xls)
[Neonate vs. Child](./results/PBMC/U133_2.0Plus.top100.DE.probesets.neonate-child.xls)
