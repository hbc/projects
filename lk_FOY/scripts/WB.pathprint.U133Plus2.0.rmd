```{r setup, echo=FALSE}
opts_chunk$set(tidy=TRUE, cache=FALSE,  highlight=TRUE, figalign="center", echo=TRUE, warning=FALSE, error=FALSE, message=FALSE, tidy.opts=list(keep.blank.line=FALSE, width.cutoff=120), fig.path="../results/WB/U133Plus2/figure/pathprint-", cache.path="cache/WB-U133Plus2-pathprint-")
options(width=200)
```
