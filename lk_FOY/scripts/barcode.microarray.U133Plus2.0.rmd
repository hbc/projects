...
load(file.path(resultsDir, "RDATA.raw_and_normalized_microarray.data.topstats.U133Plus2.0"))
```
...
- there is a slight improvement, but the arrays still don't completely cluster by age group
...
There are some genes that cluster well by age group, but also many that are homogenous across age groups. 
Independent analyses of the barcoded data should allow the barcoding process to better adjust for batch effects.
...
for (n in 1:3) {
  ...
  # both genders
  pheatmap(bc.contrast.sub, color=c("blue", "red"), cluster_rows=TRUE, cluster_cols=TRUE, show_colnames=F, show_rownames=showrownames_var, fontsize=18, fontsize_row=10, annotation=heatmap.annots, annotation_colors=ann_colors, legend_breaks=c(0,1), main=paste("Barcoded Intensities for ", contrast, " comparison",  sep=""))
  # female only
...
[Adult vs. Child](./results/U133_2.0Plus.barcode.entropy.cutoff.0.3.adult-child.xls)  
[Adult vs. Neonate](./results/U133_2.0Plus.barcode.entropy.cutoff.0.3.adult-neonate.xls)  
[Neonate vs. Child](./results/U133_2.0Plus.barcode.entropy.cutoff.0.3.neonate-child.xls) 

For the second pass, I imposed stricter criteria for intra-group entropy (<0.25) and let the entropy across both groups be higher than this value.
...
[Adult vs. Child](./results/U133_2.0Plus.barcode.entropy.cutoff.0.25.adult-child.xls)  
[Adult vs. Neonate](./results/U133_2.0Plus.barcode.entropy.cutoff.0.25.adult-neonate.xls)  
[Neonate vs. Child](./results/U133_2.0Plus.barcode.entropy.cutoff.0.25.neonate-child.xls)
