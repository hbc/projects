...
covars <- covars[!(grepl("1088831.cel", covars$CELfileloc)),]
...
exclude.arrays <-c("GSM901488","GSM901590","GSM901596","GSM901715","GSM901822","M036","GSM1373917","GSM102993","GSM648590","GSM648596","GSM648718","GSM244499","GSM102983","GSM102984","GSM102998","GSM103013","GSM103015","GSM103057","GSM648643","GSM648645","GSM648647","GSM648682","GSM648704","GSM648706")
...
exclude.arrays <- c("GSM901535","GSM901787","M099","M144","M173","GSM102978","GSM103067","GSM647548","GSM647628","GSM103007","GSM103048","GSM648656","GSM647529","GSM647574","GSM647597","GSM647600","GSM350178")
    
mic.raw <- mic.raw[,which(!(row.names(pData(mic.raw)) %in% exclude.arrays))]
save(list="mic.raw", file=file.path(resultsDir, "RDATA.mic.raw.no.outliers"))
```
...
save(list="mic.norm", file=file.path(resultsDir, "RDATA.mic.norm.no.outliers"))
```
...
for(n in 1:3){
  ...
  study_colors <- c(cbPalette, "#FF0000", "#00FF00")
  ...
  ## Heatmaps
  svg(filename = paste("DE_heatmap", gsub(" ", "", contrast), "svg", sep="."), width=8, height=11)
  plot.new()
...
# annotation colors
  ...
  ann_colors = list(gender=gender_colors, study = study_colors, stage = stage_colors)
## Heatmaps
svg(filename = "allheatmap.svg", width=8, height=11)
plot.new()
