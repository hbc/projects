```{r setup, echo=FALSE}
opts_chunk$set(tidy=TRUE, cache=FALSE,  highlight=TRUE, figalign="center", echo=TRUE, warning=FALSE, error=FALSE, message=FALSE, tidy.opts=list(keep.blank.line=FALSE, width.cutoff=120), fig.path="figure/WB-U133Plus2-microarray-", cache.path="cache/WB-U133Plus2-microarray-")
options(width=200)
```
...
```{r drop_outliers, eval=TRUE, results='asis'}
...
### Array QC checks on normalized data with ArrayQualityMetrics without outliers

```{r normQCwooutliers, eval=FALSE}
...
[Normalized Data QC Report after removing outlier studies](../results/WB/U133Plus2/QCreport_norm.wo.outliers/index.html)
