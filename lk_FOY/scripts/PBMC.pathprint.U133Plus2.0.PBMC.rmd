```{r setup, echo=FALSE}
opts_chunk$set(tidy=TRUE, cache=FALSE,  highlight=TRUE, figalign="center", echo=TRUE, warning=FALSE, error=FALSE, message=FALSE, tidy.opts=list(keep.blank.line=FALSE, width.cutoff=120), fig.path="../results/PBMC/U133Plus2/figure/pathprint-", cache.path="cache/PBMC-U133Plus2-pathprint-")
options(width=200)
```
...
[Nexus file of pathprint results](./results/PBMC/fingerprints.adult.child.PBMC.nxs)  
...
```{r default_contrasts, fig.width=12, fig.height=12}
# for each comparison
for (n in 1:3) {
  ...
  # both genders
  pheatmap(mic.f.default.contrast.sub, color=c("blue", "white", "red"), cluster_rows=T, cluster_cols=T, show_colnames=F, annotation=heatmap.annots,  legend_breaks=c(-1,0,1),main=paste("Pathways for ", contrast, "\ncomparison - clustered",  sep=" "), fontsize=14, fontsize_row=10, annotation_colors=ann_colors)
  pheatmap(mic.f.default.contrast.sub, color=c("blue", "white", "red"), cluster_rows=T, cluster_cols=F, show_colnames=F, annotation=heatmap.annots,  legend_breaks=c(-1,0,1),main=paste("Pathways for ", contrast, "\ncomparison - unclustered",  sep=" "), fontsize=14, fontsize_row=10, annotation_colors=ann_colors)
  
# female only
  mic.f.default.contrast.sub.female <- mic.f.default.contrast.sub[,which(pData.contrast$gender=="FEMALE")]
  pheatmap(mic.f.default.contrast.sub.female, color=c("blue", "white", "red"), cluster_rows=T, cluster_cols=T, show_colnames=F, annotation=heatmap.annots,  legend_breaks=c(-1,0,1),main=paste("Pathways for ", contrast, "\ncomparison - clustered - FEMALE",  sep=" "), fontsize=14, fontsize_row=10, annotation_colors=ann_colors)
  pheatmap(mic.f.default.contrast.sub.female, color=c("blue", "white", "red"), cluster_rows=T, cluster_cols=F, show_colnames=F, annotation=heatmap.annots,  legend_breaks=c(-1,0,1),main=paste("Pathways for ", contrast, "\ncomparison - unclustered - FEMALE",  sep=" "), fontsize=14, fontsize_row=10, annotation_colors=ann_colors)
  # male only
  mic.f.default.contrast.sub.male <- mic.f.default.contrast.sub[,which(pData.contrast$gender=="MALE")]
  pheatmap(mic.f.default.contrast.sub.male, color=c("blue", "white", "red"), cluster_rows=T, cluster_cols=T, show_colnames=F, annotation=heatmap.annots,  legend_breaks=c(-1,0,1),main=paste("Pathways for ", contrast, "\ncomparison - clustered - MALE",  sep=" "), fontsize=14, fontsize_row=10, annotation_colors=ann_colors)
  pheatmap(mic.f.default.contrast.sub.male, color=c("blue", "white", "red"), cluster_rows=T, cluster_cols=F, show_colnames=F, annotation=heatmap.annots,  legend_breaks=c(-1,0,1),main=paste("Pathways for ", contrast, "\ncomparison - unclustered - MALE",  sep=" "), fontsize=14, fontsize_row=10, annotation_colors=ann_colors)
  }
```
