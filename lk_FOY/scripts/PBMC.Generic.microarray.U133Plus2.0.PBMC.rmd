```{r setup, echo=FALSE}
opts_chunk$set(tidy=TRUE, cache=FALSE,  highlight=TRUE, figalign="center", echo=TRUE, warning=FALSE, error=FALSE, message=FALSE, tidy.opts=list(keep.blank.line=FALSE, width.cutoff=120), fig.path="figure/PBMC-U133Plus2-microarray-", cache.path="cache/PBMC-U133Plus2-microarray-")
options(width=200)
```
...
That metadata file is [here](../meta/PBMC/unified.metadata.refined.PBMC.U133Plus2.0.xls)
...
[Raw Data QC Report](../results/PBMC/U133Plus2/QCreport_raw/index.html)
...
[Normalized Data QC Report](../results/PBMC/U133Plus2/QCreport_norm/index.html)
...
[Normalized Data QC Report after removing outlier studies](../results/PBMC/U133Plus2/QCreport_norm.wo.outliers/index.html)
...
[All Expression Values for all Samples](../results/PBMC/U133Plus2/U133_2.0Plus.all.exprs.xls)  
...
[Adult vs. Child](../results/PBMC/U133Plus2/U133_2.0Plus.stats.exprs.adult-child.xls)  
[Adult vs. Neonate](../results/PBMC/U133Plus2/U133_2.0Plus.stats.exprs.adult-neonate.xls)  
[Neonate vs. Child](../results/PBMC/U133Plus2/U133_2.0Plus.stats.exprs.neonate-child.xls) 
