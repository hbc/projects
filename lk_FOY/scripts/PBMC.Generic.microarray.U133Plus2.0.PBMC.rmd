...
- removed GSM844204,GSM253697,GSM253700,GSM253707, GSM253708 failed RLE in raw QC. 
- removed GSM253709 as it failed intensity, and MA check in raw QC
- removed GSM253667 as it is an outlier in raw QC and post-normalized QC

- slope for RNA degradation plots for GSE14642 is very different (flat), kept in but it's worth keeping an eye on it

- renormalize data

```{r drop_outliers}
mic.raw <- mic.raw[,which(!(unlist(pData(mic.raw)$ID) %in% c("GSM844204","GSM253697","GSM253700","GSM253707", "GSM253708", "GSM253709","GSM253667" )))]
mic.norm.eset <- rma(mic.raw, normalize=TRUE, background=TRUE)
