...
Load in normalized data from virtualarray?

- need to combine the GPL96 and GPL97 samples from GSE8650 at some point, or just drop the GPL97 (U133B) arrays
...
for(n in 1:3) {
  ...
  ## Heatmaps
  # both genders
  pheatmap(as.matrix(top.barcodes.contrast), color=c("blue", "red"), annotation=heatmap.annots, annotation_colors=ann_colors, legend_breaks=c(0,1), main=contrast, show_colnames=F, fontsize=18, fontsize_row=10, cluster_cols=FALSE, cluster_rows=T) 
  # female gender
  top.barcodes.contrast.female <- top.barcodes.contrast[,which(pData.contrast$gender=="FEMALE")]
  pheatmap(as.matrix(top.barcodes.contrast.female), color=c("blue", "red"), annotation=subset(heatmap.annots, gender=="FEMALE"), main=paste(contrast, "(FEMALE)", sep=" "),show_colnames=F, fontsize=18, fontsize_row=10,legend_breaks=c(0,1), annotation_colors=ann_colors, cluster_cols=F, cluster_rows=T) 
  # male gender
  top.barcodes.contrast.male <- top.barcodes.contrast[,which(pData.contrast$gender=="MALE")]
  pheatmap(as.matrix(top.barcodes.contrast.male), color=c("blue", "red"), annotation=subset(heatmap.annots,gender=="MALE"), main=paste(contrast, "(MALE)", sep=" "),show_colnames=F, fontsize=18, fontsize_row=10, annotation_colors=ann_colors, legend_breaks=c(0,1), cluster_cols=F, cluster_rows=T) 
  }
# cleanup
