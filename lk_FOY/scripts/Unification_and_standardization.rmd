...
- in this section, I downloaded the metadata for all the whole blood studies Les shared in his [Whole Blood Array Inventory](./meta/WHOLEBLOODArrayINVENTORYMarch4update.pages)
...
To allow later extraction of the relevant subset of each study's metadata, these values were then compiled in a [columnID translator table](./meta/columnid.translator.tab).
...
This file was manually modified to make a [new file](./meta/MasterOneAllWholeBloodU133Plus2Marchd6-JHUpdate.xlsx)  with:  
...
The file with the unified (but not consistent) metadata can be found [here](./meta/unified.metadata.unrefined.tab)
...
The unified, refined metadata file can be found [here](./meta/unified-metadata-refined.04-07-13.xls)
