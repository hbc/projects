...
Bring in as many array types as possible

Arrays for which there are background Pathprint distributions.

Platforms then include HT12v3 (GPL6947), U133.plus2 (GPL570, A-AFFY-44), U133.A (GPL96, A-AFFY-33) and U133.A.2 (GPL571, GPL9188).

Also subsetted to samples for which we have gender, age and raw data

For U133Plus2.0 arrays excluded the "GSE18897", "MEXP-2917", "TABM-940", "TABM-666",  studies (which I excluded from the previous U133Plus2.0 analyses). 

For U133A arrays, based off the virtualarray U133 results, GSM768546 and GSM768549  (i.e. GSE31014 study) will be removed due to failed Relative Log Expression (RLE) outlier detection and Normalized Unscaled Standard Error (NUSE) tests. There also appear to be some visual artefacts on the GSM768549 array.

For U133A.2 arrays, based off the virtualarray U133 results, all arrays from GSE17732 (GSM442648.CEL, GSM442649.CEL, GSM442650.CEL, GSM442651.CEL, GSM442652.CEL, GSM442653.CEL) failed both or either of the RLE and NUSE tests and will be removed. The individual arrays GSE17732.CEL, GSM474745.CEL, GSM474756.CEL, GSM539024.CEL, GSM539027.CEL, GSM539028.CEL, GSM758056.CEL, GSM758072.CEL also failed either of the RLE and NUSE tests and will be removed.

Note I only examined and excluded arrays within the defined age ranges of:
- neonate = 0-4 years
- child = 5-10 years
- adult = 18-40 years 
If we expand these age ranges, I will need to revisit the excluded arrays.
...
refined.metadata  <- refined.metadata[refined.metadata$platform %in% c("GPL6947", "GPL570", "A-AFFY-44","GPL96", "A-AFFY-33", "GPL571", "GPL9188"),]
refined.metadata <- refined.metadata[!(refined.metadata$sampleID %in% c("GSE18897", "MEXP-2917", "TABM-940", "TABM-666")),]
