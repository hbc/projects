```{r setup, echo=FALSE}
opts_chunk$set(tidy=TRUE, cache=FALSE,  highlight=TRUE, figalign="center", echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, tidy.opts=list(keep.blank.line=FALSE, width.cutoff=120), fig.path="figure/sepsis-unify-", cache.path="cache/sepsis-unify-")
options(width=200)
```
...
```{r GEOIDs}
GSEids <- c("GSE28750", "GSE11755", "GSE4607", "GSE13904", "GSE26440", "GSE26378", "GSE9692", "GSE36809", "GSE11375", "GSE13015","GSE10474","GSE32707","GSE40586","GSE5580","GSE22278","GSE3026","GSE3284")
...
Metadata from GSE26440 and GSE26378 need no modifications, but the metadata filename was modified for consistency.
...
wong.metadata <- read.delim(file.path(dataDir, "GSE4607", "Wong_metadata.GSE4607.tab"), 
                                    sep="\t", 
                                    header=T)
wong.metadata$age_years <-   as.vector(difftime(mdy(as.character(unlist(wong.metadata$Enrollment.Date))),
           mdy(as.character(unlist(wong.metadata$Date.of.Birth))), 
           unit="days")/365)
