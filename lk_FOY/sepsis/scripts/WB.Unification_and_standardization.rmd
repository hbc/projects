...
```{r GEOIDs}
GSEids <- c("GSE28750", "GSE11755", "GSE4607", "GSE13904", "GSE26440", "GSE26378", "GSE9692", "GSE36809", "GSE11375", "GSE13015","GSE10474","GSE32707","GSE40586","GSE5580","GSE22278","GSE3026","GSE3284", "GSE54514")
...
Metadata from GSE26440,  GSE26378 and GSE54514 need no modifications, but the metadata filenames were modified for consistency.
...
write.table(metadata, file=file.path(dataDir, "BD", "metadata.BD.tab"), sep="\t", quote=F, row.names=FALSE, col.names=TRUE)
```
