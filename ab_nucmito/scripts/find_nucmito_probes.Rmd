...
#kable(mito.pos)
write.xlsx2(mito.pos, file="nuclear.mitochondrial.genes.xlsx")
```

### [Excel file with mitochondrial genes on nuclear chromosome](nuclear.mitochondrial.genes.xlsx)
...
### [Excel file with results](probes450K.in.flanked.nucmitos.xlsx)
