...
autoplot(seqinfo(diffs.b1.gr.f1), layout = "karyogram") +
...
autoplot(seqinfo(diffs.b1.hyper.gr.f1), layout = "karyogram") +
...
autoplot(seqinfo(diffs.b1.gr.f2), layout = "karyogram") +
...
autoplot(seqinfo(diffs.b1.hyper.gr.f2), layout = "karyogram") +
...
autoplot(seqinfo(diffs.b1.gr.f3), layout = "karyogram") +
...
autoplot(seqinfo(diffs.b1.hyper.gr.f3), layout = "karyogram") +
...
autoplot(seqinfo(diffs.b1.hyper.gr.f3), layout = "karyogram", main="Faf") +
