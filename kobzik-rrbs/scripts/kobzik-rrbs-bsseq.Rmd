...
[F1 vs. control differentially methylated sites](../results/differentially.methylated.CpGs.f1.vs.control.csv)

[F2 vs. control differentially methylated sites](../results/differentially.methylated.CpGs.f2.vs.control.csv)

[F3 vs. control differentially methylated sites](../results/differentially.methylated.CpGs.f3.vs.control.csv)
