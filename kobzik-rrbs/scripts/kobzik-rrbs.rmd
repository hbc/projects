...
save.image(file=file.path(baseDir, "RDATA.filtered.normalized.united"))
```
...
#batch 1
meth.quants.b1F1.filtered.merged.new <- reorganize(meth.quants.filtered.merged ,sample.ids=c("15-b1-cntr", "16-b1-cntr", "17-b1-cntr", "1-b1-F1", "2-b1-F1", "3-b1-F1", "4-b1-F1"), treatment=c(0,0,0,1,1,1,1) )
meth.quants.b1F2.filtered.merged.new <- reorganize(meth.quants.filtered.merged ,sample.ids=c( "15-b1-cntr", "16-b1-cntr", "17-b1-cntr",  "5-b1-F2", "6-b1-F2", "7-b1-F2", "8-b1-F2"), treatment=c(0,0,0,1,1,1,1) )
meth.quants.b1F3.filtered.merged.new <- reorganize(meth.quants.filtered.merged ,sample.ids=c( "15-b1-cntr", "16-b1-cntr", "17-b1-cntr",  "10-b1-F3", "11-b1-F3", "12-b1-F3", "13-b1-F3"), treatment=c(0,0,0,1,1,1,1) )

#batch 2
meth.quants.b2F1.filtered.merged.new <- reorganize(meth.quants.filtered.merged  ,sample.ids=c("123-b2-cntr","124-b2-cntr", "125-b2-cntr", "126-b2-cntr", "60-b2-F1", "61-b2-F1", "62-b2-F1", "63-b2-F1"), treatment=c(0,0,0,0,1,1,1,1) )
meth.quants.b2F2.filtered.merged.new <- reorganize(meth.quants.filtered.merged  ,sample.ids=c("123-b2-cntr","124-b2-cntr", "125-b2-cntr", "126-b2-cntr", "90-b2-F2", "91-b2-F2", "92-b2-F2", "93-b2-F2"), treatment=c(0,0,0,0,1,1,1,1) )
meth.quants.b2F3.filtered.merged.new <- reorganize(meth.quants.filtered.merged  ,sample.ids=c("123-b2-cntr","124-b2-cntr", "125-b2-cntr", "126-b2-cntr", "119-b2-F3", "120-b2-F3", "121-b2-F3", "122-b2-F3"), treatment=c(0,0,0,0,1,1,1,1) )
```
...
p7 <- PCASamples(meth.quants.b1F1.filtered.merged.new, main="Batch 1 - F1 & control - new")
p8 <- PCASamples(meth.quants.b1F2.filtered.merged.new, main="Batch 1 - F2 & control - new")
p9 <- PCASamples(meth.quants.b1F3.filtered.merged.new, main="Batch 1 - F3 & control - new")

#batch 2
p10 <- PCASamples(meth.quants.b2F1.filtered.merged.new, main="Batch 2 - F1 & control - new")
p11 <- PCASamples(meth.quants.b2F2.filtered.merged.new, main="Batch 2 - F2 & control - new")
p12 <- PCASamples(meth.quants.b2F3.filtered.merged.new, main="Batch 2 - F3 & control - new")

grid.arrange(p1,p7,p4,p10,p2,p8,p5,p11,p3,p9,p6,p12 , ncol=2)
```
...
b1F1.diffMeth.new <- calculateDiffMeth(meth.quants.b1F1.filtered.merged.new,slim=TRUE,  weighted.mean=TRUE,num.cores=2)
b1F2.diffMeth.new <- calculateDiffMeth(meth.quants.b1F2.filtered.merged.new,slim=TRUE,  weighted.mean=TRUE,num.cores=2)
b1F3.diffMeth.new <- calculateDiffMeth(meth.quants.b1F3.filtered.merged.new,slim=TRUE,  weighted.mean=TRUE,num.cores=2)

#batch2
b2F1.diffMeth.new <- calculateDiffMeth(meth.quants.b2F1.filtered.merged.new,slim=TRUE,  weighted.mean=TRUE,num.cores=2)
b2F2.diffMeth.new <- calculateDiffMeth(meth.quants.b2F2.filtered.merged.new,slim=TRUE,  weighted.mean=TRUE,num.cores=2)
b2F3.diffMeth.new <- calculateDiffMeth(meth.quants.b2F3.filtered.merged.new,slim=TRUE,  weighted.mean=TRUE,num.cores=2)

save.image(file=file.path(baseDir, "RDATA.filtered.normalized.united-diffs"))
