...
bowtiegenome="/n/scratch00/hsph/genomes/Mmusculus/mm9/iGenomes/Ensembl/NCBIM37/Sequence/BowtieIndex/genome"
...
if [ $trim_size -eq 0 ]
then
    trimvarDir="ensembl_untrimmed"
else 
    trimvarDir="ensembl_trimmed"
fi
