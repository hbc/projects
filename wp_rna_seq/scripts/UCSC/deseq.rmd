...
- took a less conservative approach to reducing the variability of the dispersion estimates
...
counts.ds <- estimateDispersions(counts.ds, method="pooled", modelFrame=covars[,1:3], sharingMode="fit-only", fitType="parametric")
