...
#kable(telo.pos)
write.table( telo.pos, file.path(resultsDir, file="telomeric.function.gene.locations.xls"), sep="\t", quote=F, row.names=F, col.names=T)
```

### [Telomeric function gene locations](telomeric.function.gene.locations.xls)
...
### [Excel file with results](probes450K.in.flanked.telos.xls)
