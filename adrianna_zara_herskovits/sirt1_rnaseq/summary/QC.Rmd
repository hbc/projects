...
bcbioRNASeq::plotPCA(bcb, label=FALSE,interestingGroups="age")
bcbioRNASeq::plotPCA(bcb, label=FALSE,interestingGroups="generalGeno")
bcbioRNASeq::plotPCA(bcb, label=FALSE,interestingGroups="sibset")
bcbioRNASeq::plotPCA(bcb, label=FALSE,interestingGroups="class")
bcbioRNASeq::plotPCA(bcb, label=FALSE,interestingGroups=c("class", "sibset"))


plotPCA(bcb, interestingGroups=c("age", "generalGeno"))
```
...
Age appears to have the strongest correlation, with both principal components. The correlations between exonic rate, intergenic rate and G
