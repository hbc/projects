---
title: "Young versus Old Differential Expression - Transgenic Specific"
...
params:
    ...
    contrast: !r c("group", "TG-young", "TG-old")
    alpha: 0.1
    lfc: 0.5849625
    outputDir: "."
---
...
deDir <- file.path(outputDir, "results", "differential_expression", "age_effects", "transgenic")
```
...
alphaSummary(dds, contrast=c("group", "TG-young", "TG-old"))
```
...
group_tg_young_vs_tg_old_all.csv.gz - statistics and annotations for all genes       
group_tg_young_vs_tg_old_deg.csv.gz - statistics and annotations for differentially expressed genes
group_tg_young_vs_tg_old_deg_lfc_down.csv.gz - statistics and annotations for differentially expressed genes that are up in first listed sample class (i.e. if filename is 1_vs_2, genes are more highly expressed in 1)
...
gprofiler_results_group_tg_young_vs_tg_old.csv
