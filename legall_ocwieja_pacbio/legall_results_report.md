...
Finally, to identify the corresponding proteins for the HIV NL4-3 strain, the genomic coordinates for the each exon identified in the Ocwieja paper was converted from the genomic coordinates of the HIV 89.6 strain (GenBank: U39362.2) to the NL4-3 strain (GenBank: AF324493.2) using KentUtils liftover similar to the Ocwieja analysis. Using the new coordinates the same workflow was completed as for the 89.6 strain to identify potential ORFs and proteins. 
