...
A Pacbio protein that aligned in it's entirety (full length) to an Ocwieja protein is more likely to have originated from the designated HIV Ocwieja protein than a Pacbio protein that did not completely align to the Ocwieja protein. Using these uniquely aligning full-length Pacbio proteins 51 of the 108 Ocwieja proteins were identified. Descriptive statistics describing the Pacbio proteins can be found in the table below:
