...
dataDir=file.path(baseDir, "data/microarray")
resultsDir=file.path(baseDir, "results/microarray")
...
colnames(design) <- sub("factor.pData.affyNorm.core... grouplabel..", "", colnames(design))
