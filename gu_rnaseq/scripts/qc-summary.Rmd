...
library(pheatmap)
library(DESeq2)
project_summary = "/Volumes/orch/group_dir/gu_rnaseq/project/final/2016-02-16_project/project-summary.csv"
counts_file = "/Volumes/orch/group_dir/gu_rnaseq/project/final/2016-02-16_project/combined.counts"
...
With the exception of the LE2, LE3 and LE4 samples, there's actually really good separation between the retinal and lung samples. PC1 (i.e. the largest sources of variation in your dataset) is capturing the difference between these 3 samples and the rest of the samples and PC2 (the next largest sources of variation in your dataset) is capturing the difference betwen the retinal and lung samples.
...
This  PCA plot (PC1 against PC2) is looking at the DESeq2 normalized count data after variance stabilization.


```{r pca}
dds = DESeqDataSetFromMatrix(countData=counts, colData=summarydata, design=~day+sampletype)
vst = rlog(dds)
